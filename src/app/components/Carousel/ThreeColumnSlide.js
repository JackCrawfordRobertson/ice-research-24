...
export default function ThreeColumnSlide({ column2Title, column2Text, column3Title, column3Content, interactiveChart }) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className={styles.column3}>
        ...
        <div className={styles.Body}>Hover over and click on the chart to interact with the data.</div>
